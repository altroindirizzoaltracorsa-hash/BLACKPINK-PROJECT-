...
const SONGS = {
  ...
  jennie: [
    ...
    { id: 'je-fly',           song: 'Fly',               artist: 'JENNIE', searchTerm: 'Fly JENNIE Doja Cat', section: 'RUBY' },
    { id: 'je-oneofthegirls', song: 'One of the Girls',  artist: 'JENNIE', searchTerm: 'One of the Girls JENNIE Sabrina Carpenter Doechii', section: 'RUBY' },
  ...
  lisa: [
    ...
    { id: 'li-fxxxup',      song: 'Fxck Up The World', artist: 'LISA', section: 'ALTER EGO' },
