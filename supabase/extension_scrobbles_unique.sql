...
--
-- ORDER MATTERS: dedupe any existing duplicates FIRST. This index will fail to
-- create while duplicate rows still exist. Run this in the Supabase SQL editor.
...
-- api/ingest-scrobble.js upserts with
